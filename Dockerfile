...
RUN apk add php84-bcmath php84-bz2 php84-calendar php84-ctype php84-curl php84-dom php84-gd \
    ...
    php84-xml php84-apcu php84-mysqli php84-session php84-simplexml php84-tokenizer php84-opcache \
    php84-sqlite3 php84-pgsql php84-pdo_mysql php84-pdo_pgsql git wget
...
COPY it-infra/opi-pc2.conf /etc/nginx/http.d
